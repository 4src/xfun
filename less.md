...
Now programs are tools for changing the world; i.e. they are functions $f$ for turning inputs  $x$ to outputs $y$. This means
...
Cluster what your know into a few groups, then just reason about a few items per groups. This works for many applications:

- Test case reduction: instead of testing everything, just test a small sample.

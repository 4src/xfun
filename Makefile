...
pulled: ## grab a commit message, commit github
...
docs/%.html : %.lisp etc/lisp2mdA.awk etc/lisp2mdB.awk docs/ezr.css etc/b4.html Makefile
	gawk -f etc/lisp2mdA.awk $<                   \
	| gawk -f etc/lisp2mdB.awk                     \
